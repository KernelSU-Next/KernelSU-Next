...
## Licensz
- A `kernel` könyvtárban található fájlok: [GPL-2.0](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html).
- A `kernel` könyvtár kivételével minden más: [GPL-3.0-vagy újabb](https://www.gnu.org/licenses/gpl-3.0.html).
