            ...
            if (state.showRequireKernelWarning) {
                WarningCard(
                    stringResource(id = R.string.require_kernel_version,
                        state.ksuVersion ?: 0,
                        com.rifsxd.ksunext.Natives.MINIMAL_SUPPORTED_KERNEL
                    )
                )
            }
                ...
                when {
                    state.ksuVersion != null -> {
                        ...
                        Column(Modifier.padding(start = 20.dp)) {
                            ...
                            Text(
                                text = stringResource(R.string.home_working_version, state.ksuVersionTag ?: "v0.0.0", state.ksuVersion),
...
private fun previewHomeScreenState(
    ...
    latestVersionInfo = com.rifsxd.ksunext.ui.util.module.LatestVersionInfo(),
