package com.rifsxd.ksunext.magica;

import static com.rifsxd.ksunext.magica.AppZygotePreload.TAG;
...
import com.rifsxd.ksunext.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.rifsxd.ksunext.magica.LAUNCH".equals(action)) {
            return;
        }
